    ...
    <div key={id} className="cart-item">
        ...
        <div className="item-info">
          ...
          <div className="item-qty">
            ...
            <div>
                <button className="yellow-button qty-button qty-plus-button" onClick={()=>onIncQuantity(id)}>+</button>
                <button className="yellow-button qty-button qty-plus-button" onClick={()=>onDecQuantity(id)}>-</button>
            </div>
            </div>
        </div>
    </div>
...
function Cart({showCart,closeCart,cartItems,onIncQuantity,onDecQuantity}){
    ...
    <Modal show={showCart} onClose={closeCart}>
        <div className="cart-container">
            <p className="cart-heding">Cart</p>
            { cartItems.length===0 ? 
